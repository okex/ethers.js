...
function setupContext(path, context, plugin) {
    ...
    context.ethers = exchain_ethers_1.ethers;
    context.version = exchain_ethers_1.ethers.version;
    context.Contract = exchain_ethers_1.ethers.Contract;
    context.ContractFactory = exchain_ethers_1.ethers.ContractFactory;
    context.Wallet = exchain_ethers_1.ethers.Wallet;
    context.providers = exchain_ethers_1.ethers.providers;
    context.utils = exchain_ethers_1.ethers.utils;
    context.abiCoder = exchain_ethers_1.ethers.utils.defaultAbiCoder;
    context.BN = exchain_ethers_1.ethers.BigNumber;
    context.BigNumber = exchain_ethers_1.ethers.BigNumber;
    context.FixedNumber = exchain_ethers_1.ethers.FixedNumber;
    context.getAddress = exchain_ethers_1.ethers.utils.getAddress;
    context.getContractAddress = exchain_ethers_1.ethers.utils.getContractAddress;
    context.getIcapAddress = exchain_ethers_1.ethers.utils.getIcapAddress;
    context.arrayify = exchain_ethers_1.ethers.utils.arrayify;
    context.concat = exchain_ethers_1.ethers.utils.concat;
    context.hexlify = exchain_ethers_1.ethers.utils.hexlify;
    context.zeroPad = exchain_ethers_1.ethers.utils.zeroPad;
    context.joinSignature = exchain_ethers_1.ethers.utils.joinSignature;
    context.splitSignature = exchain_ethers_1.ethers.utils.splitSignature;
    context.id = exchain_ethers_1.ethers.utils.id;
    context.keccak256 = exchain_ethers_1.ethers.utils.keccak256;
    context.namehash = exchain_ethers_1.ethers.utils.namehash;
    context.sha256 = exchain_ethers_1.ethers.utils.sha256;
    context.parseEther = exchain_ethers_1.ethers.utils.parseEther;
    context.parseUnits = exchain_ethers_1.ethers.utils.parseUnits;
    context.formatEther = exchain_ethers_1.ethers.utils.formatEther;
    context.formatUnits = exchain_ethers_1.ethers.utils.formatUnits;
    context.randomBytes = exchain_ethers_1.ethers.utils.randomBytes;
    context.constants = exchain_ethers_1.ethers.constants;
    context.parseTransaction = exchain_ethers_1.ethers.utils.parseTransaction;
    context.serializeTransaction = exchain_ethers_1.ethers.utils.serializeTransaction;
    context.toUtf8Bytes = exchain_ethers_1.ethers.utils.toUtf8Bytes;
    context.toUtf8String = exchain_ethers_1.ethers.utils.toUtf8String;
}
...
var SandboxPlugin = /** @class */ (function (_super) {
    ...
    SandboxPlugin.prototype.run = function () {
        console.log("version: " + exchain_ethers_1.ethers.version);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        wallet = exchain_ethers_1.ethers.Wallet.createRandom();
    ...
    FundPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, exchain_ethers_1.ethers.utils.fetchJson(url).then(function (data) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        args.forEach(function (arg) {
                            if (exchain_ethers_1.ethers.utils.isAddress(arg)) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, exchain_ethers_1.ethers.utils.resolveProperties({
                    ...
                    case 2:
                        ...
                        info = {
                            "Address": address,
                            "Balance": (exchain_ethers_1.ethers.utils.formatEther(balance) + " ether"),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.data = exchain_ethers_1.ethers.utils.hexlify(argParser.consumeOption("data") || "0x");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.value = exchain_ethers_1.ethers.utils.parseEther(args[1]);
                        return [2 /*return*/];
                }
            });
        });
...
var SweepPlugin = /** @class */ (function (_super) {
    ...
    SweepPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, exchain_ethers_1.ethers.utils.resolveProperties({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.value = exchain_ethers_1.ethers.utils.parseEther(args[0]);
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                    case 2:
                        address = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Wrapping ether", {
                            "From": address,
                            "Value": exchain_ethers_1.ethers.utils.formatEther(this.value)
                        });
                        contract = new exchain_ethers_1.ethers.Contract(WethAddress, WethAbi, this.accounts[0]);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.contract = new exchain_ethers_1.ethers.Contract(tokenAddress, Erc20Abi, this.accounts[0]);
                        _a = this;
                    ...
                    case 4:
                        _b.toAddress = _c.sent();
                        this.value = exchain_ethers_1.ethers.utils.parseUnits(args[2], this.decimals);
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    case 0:
                        info = {
                            ...
                            "Value": exchain_ethers_1.ethers.utils.formatUnits(this.value, this.decimals)
                        };
                        namePromise = this.contract.name().then(function (name) {
                            ...
                            var contract = new exchain_ethers_1.ethers.Contract(_this.contract.address, Erc20AltAbi, _this.contract.signer);
                            contract.name().then(function (name) {
                                info["Token Name"] = exchain_ethers_1.ethers.utils.parseBytes32String(name);
                            }, function (error) {
                                throw error;
                            });
                        });
                        symbolPromise = this.contract.symbol().then(function (symbol) {
                            ...
                            contract.symbol().then(function (symbol) {
                                info["Token Symbol"] = exchain_ethers_1.ethers.utils.parseBytes32String(symbol);
                            }, function (error) {
                                throw error;
                            });
                        });
            ...
            return __generator(this, function (_a) {
                ...
                result.forEach(function (contract, index) {
                    output[contract.name] = {
                        ...
                        interface: contract.interface.fragments.map(function (f) { return f.format(exchain_ethers_1.ethers.utils.FormatTypes.full); }),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        factory = new exchain_ethers_1.ethers.ContractFactory(codes[0].interface, codes[0].bytecode, this.accounts[0]);
                        cli_1.dump("Deploying:", {
                            Contract: codes[0].name,
                            Bytecode: codes[0].bytecode,
                            Interface: codes[0].interface.fragments.map(function (f) { return f.format(exchain_ethers_1.ethers.utils.FormatTypes.full); }),
