...
For signing, see the [Abstract Signer](https://www.npmjs.com/package/@exchain-ethersproject/abstract-signer)
or [Wallet](https://www.npmjs.com/package/@exchain-ethersproject/wallet) sub-modules.
...
} = require("@exchain-ethersproject/abstract-provider");
```
