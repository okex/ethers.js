...
var bnify = exchain_ethers_1.ethers.BigNumber.from;
var blockchainData = {
    homestead: {
        addresses: [
            {
...
function equals(name, actual, expected) {
    if (expected && expected.eq) {
        ...
        expected = exchain_ethers_1.ethers.BigNumber.from(expected);
        actual = exchain_ethers_1.ethers.BigNumber.from(actual);
...
function getApiKeys(network) {
    ...
    var apiKeys = exchain_ethers_1.ethers.utils.shallowCopy(_ApiKeys);
...
var providerFunctions = [
    {
        ...
        create: function (network) {
            if (network == "default") {
                return exchain_ethers_1.ethers.getDefaultProvider(null, getApiKeys(network));
            }
            return exchain_ethers_1.ethers.getDefaultProvider(network, getApiKeys(network));
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new exchain_ethers_1.ethers.providers.AlchemyProvider(null, getApiKeys(network).alchemy);
            }
            return new exchain_ethers_1.ethers.providers.AlchemyProvider(network, getApiKeys(network).alchemy);
        }
    },
    /*
    {
    ...
    */
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new exchain_ethers_1.ethers.providers.InfuraProvider(null, getApiKeys(network).infura);
            }
            return new exchain_ethers_1.ethers.providers.InfuraProvider(network, getApiKeys(network).infura);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new exchain_ethers_1.ethers.providers.EtherscanProvider(null, getApiKeys(network).etherscan);
            }
            return new exchain_ethers_1.ethers.providers.EtherscanProvider(network, getApiKeys(network).etherscan);
        }
    },
    {
    ...
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new exchain_ethers_1.ethers.providers.PocketProvider(null, {
                    applicationId: getApiKeys(network).pocket,
                    loadBalancer: true
                });
            }
            return new exchain_ethers_1.ethers.providers.PocketProvider(network, {
                applicationId: getApiKeys(network).pocket,
                loadBalancer: true
            });
        }
...
var fundWallet = exchain_ethers_1.ethers.Wallet.createRandom();
var testFunctions = [];
...
(function () {
    ...
    function addErrorTest(code, func) {
        ...
        testFunctions.push({
            ...
            checkSkip: function (provider, network, test) {
                ...
                return (code === exchain_ethers_1.ethers.utils.Logger.errors.UNPREDICTABLE_GAS_LIMIT && provider === "EtherscanProvider");
                //return false;
            },
            execute: function (provider) { return __awaiter(_this, void 0, void 0, function () {
                var value, error_1;
    ...
    */
    ...
    addErrorTest(exchain_ethers_1.ethers.utils.Logger.errors.NONCE_EXPIRED, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    addErrorTest(exchain_ethers_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
    ...
    addErrorTest(exchain_ethers_1.ethers.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wallet = exchain_ethers_1.ethers.Wallet.createRandom().connect(provider);
            return [2 /*return*/, wallet.sendTransaction(txProps)];
        });
    }); });
    addErrorTest(exchain_ethers_1.ethers.utils.Logger.errors.UNPREDICTABLE_GAS_LIMIT, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    execute: function (provider) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    b0 = _a.sent();
                    assert_1.default.ok(b0.gt(exchain_ethers_1.ethers.constants.Zero), "balance is non-zero");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        provider = new exchain_ethers_1.ethers.providers.InfuraProvider("ropsten", getApiKeys("ropsten").infura);
                        return [4 /*yield*/, exchain_ethers_1.ethers.utils.fetchJson("https://api.ethers.io/api/v1/?action=fundAccount&address=" + fundWallet.address.toLowerCase())];
                    case 1:
                        funder = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        provider = new exchain_ethers_1.ethers.providers.EtherscanProvider(null, getApiKeys(null).etherscan);
...
describe("Test Basic Authentication", function () {
    ...
    function test(name, url) {
        it("tests " + name, function () {
            this.timeout(60000);
            return exchain_ethers_1.ethers.utils.fetchJson(url).then(function (data) {
    ...
    it("tests insecure connections fail", function () {
        ...
        assert_1.default.throws(function () {
            return exchain_ethers_1.ethers.utils.fetchJson(insecure);
        }, function (error) {
...
describe("Test API Key Formatting", function () {
    it("Infura API Key", function () {
        ...
        var apiKeyString = exchain_ethers_1.ethers.providers.InfuraProvider.getApiKey(projectId);
        ...
        var apiKeyObject = exchain_ethers_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId
        });
        ...
        var apiKeyObject2 = exchain_ethers_1.ethers.providers.InfuraProvider.getApiKey({
            projectId: projectId,
        ...
        assert_1.default.throws(function () {
            var apiKey = exchain_ethers_1.ethers.providers.InfuraProvider.getApiKey({
                projectId: 1234,
                projectSecret: projectSecret
            });
            console.log(apiKey);
        ...
        {
            var provider = new exchain_ethers_1.ethers.providers.InfuraProvider("homestead", {
                projectId: projectId,
                projectSecret: projectSecret
            });
        ...
        assert_1.default.throws(function () {
            var provider = new exchain_ethers_1.ethers.providers.InfuraProvider("imaginary");
    ...
    it("Pocket API key", function () {
        ...
        var apiKeyString = exchain_ethers_1.ethers.providers.PocketProvider.getApiKey(applicationId);
        ...
        var apiKeyObject = exchain_ethers_1.ethers.providers.PocketProvider.getApiKey({
        ...
        var apiKeyObject2 = exchain_ethers_1.ethers.providers.PocketProvider.getApiKey({
            applicationId: applicationId,
        ...
        assert_1.default.throws(function () {
            var apiKey = exchain_ethers_1.ethers.providers.PocketProvider.getApiKey({
                applicationId: 1234,
                applicationSecretKey: applicationSecretKey
            });
            console.log(apiKey);
        ...
        {
            var provider = new exchain_ethers_1.ethers.providers.PocketProvider("homestead", {
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey
            });
            assert_1.default.equal(provider.network.name, "homestead");
        ...
        // Attempt an unsupported network
        assert_1.default.throws(function () {
            var provider = new exchain_ethers_1.ethers.providers.PocketProvider("imaginary");
            console.log(provider);
        }, function (error) {
            return (error.argument === "network" && error.reason === "unsupported network");
        });
    ...
    it("InfuraProvider.getWebSocketProvider", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = exchain_ethers_1.ethers.providers.InfuraProvider.getWebSocketProvider();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        provider = new exchain_ethers_1.ethers.providers.InfuraProvider("rinkeby");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        wallet = new exchain_ethers_1.ethers.Wallet(exchain_ethers_1.ethers.utils.id("random-wallet"), provider);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
