...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        const pNpm = yield npm.getPackage("exchain-ethers");
        ...
        for (let i = 0; i < path_1.dirnames.length; i++) {
            ...
            const deps = Object.keys(pLocal.dependencies).reduce((accum, name) => {
                ...
                if (dirname === "exchain-ethers") {
                    if (prefix === "@exchain-ethersproject") {
                    ...
                    if (prefix === "exchain-ethers" || prefix === "@exchain-ethersproject") {
